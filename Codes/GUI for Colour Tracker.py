...
def stop():
    ...
    running = False
root = Tk()
root.title("GUI for Colour Detector")
root.geometry("800x600")
bg=PhotoImage(file="COE.png")
my_label=Label(root,image=bg)
my_label.place(x=0,y=0,relwidth=1,relheight=1)

my_text=Label(root,text="This project uses OpenCV python along with \nTkinter to detect colours and pass the information to the 6 D.O.F robotic arm \nto pick up objects based on colour and orientation of the object \n \n \n Centre of Excellence in Advanced Manufacturing Technology \nIIT Kharagpur",font=("Helvetica",10),fg="black")
my_text.grid(row=10,column=50)
app = Frame(root)
app.grid()
