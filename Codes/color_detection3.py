...
variableid1 = client.get_node("ns=5;s=MotionDeviceSystem.ProcessData.R1.System.$config.STARTCOLOURCHECK")
col_pick = client.get_node("ns=5;s=MotionDeviceSystem.ProcessData.R1.System.$config.COLORPICKED")
        ...
        while(True):
            ...
            for key, value in upper.items():
                ...
                if len(cnts) > 0:
                    ...
                    if (radius > 0.5 and col_pick.get_value()==False):
                        ...
                        if(key=='red'):
                            ...
                            green.set_value(True)
                            print("Green")
                        elif(key=='yellow'):
                            yellow.set_value(True)
                            print("Yellow")
                        elif(key=='orange'):
                            orange.set_value(True)
                            print("Orange")
